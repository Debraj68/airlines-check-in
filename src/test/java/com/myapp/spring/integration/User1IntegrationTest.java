...
public class User1IntegrationTest {
...
private static File DATA_JSON= Paths.get("src","test","resources","users.json").toFile();
	...
	public void testAddNewUser() throws Exception {
		...
		User1 newuser = new User1(50,"abc",8, "abc@gmail.com", "Shivangi","Katiyar");
		
		User1 mockuser = new User1(50,"abc",8, "abc@gmail.com", "Shivangi","Katiyar");
		//mockuser.setPnr(50);
		// Prepare Mock Service Method
